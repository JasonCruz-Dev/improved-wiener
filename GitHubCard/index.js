...
const smallGroup = ['JasonCruz-Dev', 'bradtraversy', 'ChristopherHernandezW22', 'Catherinesjkim', 'karapeoples', 'JavachipMom', 'kjdschneider', 'alisonludick', 'crispad', 'emilyseibert'];
...
// * ADDING CLASSES AND TEXTCONTENT TO BUTTONS
...
groupBtn.textContent = 'Following';
...
followersBtn.style.backgroundColor = 'maroon';
...
groupBtn.style.backgroundColor = 'maroon';
...
// * CARD COMPONENT TO RENDER THE DATASET FROM THE API CALLS
